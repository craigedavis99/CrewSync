        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p data-testid="text-about-paragraph-2">
              We also know you don't have the time—or the desire—to learn some over-engineered system that feels as painful as doing the admin work by hand. That's why we're building Crew Sync: a super simple tool that helps you stay organized, serve customers better, and run your business like you've got a 24/7 receptionist on your side.
            </p>
            ...
            <p data-testid="text-about-paragraph-4">
              And we want you to try it 100% risk free. Use Crew Sync, see how it fits your day, and if you don't love it, you can simply stop using it without paying a single dollar. If it earns its keep, we think you'll quickly see it's worth the small monthly fee.
            </p>
          </div>
        </div>
      </DialogContent>
